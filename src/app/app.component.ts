...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(private remindersService: RemindersService, private batteryStatus: BatteryStatus) {
  }

  ngOnInit() {
    this.remindersService.reminders$.subscribe(reminders => {
      this.reminders = reminders;
      this.batteryLevelSubscription = this.batteryStatus.onChange().pipe(
        ...
        this.sendNotification({
          ...
          body: 'Your phone has ' + status.level + ' left'
        });
      });
    });
  }
